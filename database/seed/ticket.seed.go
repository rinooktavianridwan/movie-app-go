...
func SeedTickets(db *gorm.DB, transactions []models.Transaction, schedules []models.Schedule) error {
	...
	ticketConfigs := []struct {
		...
		{0, 0, []int{5, 6, 7}, 75000, enums.TicketStatusUsed},

		// Transaction 2: 2 tickets (August 21)
		{1, 2, []int{1, 2}, 75000, enums.TicketStatusActive},

		// Transaction 3: 4 tickets (August 21)
		{2, 4, []int{10, 11, 12, 13}, 80000, enums.TicketStatusActive},

		// Transaction 4: 2 tickets (August 22)
		{3, 5, []int{8, 9}, 80000, enums.TicketStatusUsed},

		// Transaction 5: 3 tickets (September 1)
		{4, 6, []int{3, 4, 5}, 75000, enums.TicketStatusActive},

		// Transaction 6: 3 tickets (September 2)
		{5, 7, []int{15, 16, 17}, 75000, enums.TicketStatusActive},

		// Transaction 7: 2 tickets (October 10)
		{6, 9, []int{20, 21}, 85000, enums.TicketStatusActive},

		// Transaction 8: 3 tickets (October 15)
		{7, 10, []int{25, 26, 27}, 90000, enums.TicketStatusActive},
	}
	...
	for _, config := range ticketConfigs {
		...
		if transaction.PaymentStatus != enums.PaymentStatusSuccess {
			continue
		}
